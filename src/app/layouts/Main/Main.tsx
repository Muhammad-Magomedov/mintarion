  ...
  return (
    <>
      {isActive ? (
        ...
        >
          <Header className={cn(styles.header, "border-b-[1px] border-solid border-slate-200 dark:border-gray-650")} />
          <div className={styles.content}>
            <AppSidebar className={cn(styles.sidebar, "border-r-[1px] border-solid border-slate-200 dark:border-gray-650")} />
